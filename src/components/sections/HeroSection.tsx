...
import { SmoothFloatingElement, SmoothGradientText, SmoothMagneticElement, SmoothFadeIn } from "../ui/SmoothAnimations";
  ...
  return (
    <section id="hero" className="relative min-h-screen flex items-center justify-center text-white overflow-hidden font-sans">
      <video
        ...
        muted
        playsInline
        className="absolute inset-0 w-full h-full object-cover z-0 video-background"
      ...
      <div className="relative z-10 flex flex-col md:flex-row items-center justify-center min-h-[60vh] w-full px-4 sm:px-6 lg:px-8 py-16 sm:py-20 md:py-24 lg:py-32 gap-6 sm:gap-8 md:gap-12 lg:gap-20">
          ...
          <SmoothFadeIn delay={0.3}>
            ...
            >
              <img
                ...
                className="w-48 h-48 sm:w-64 sm:h-64 md:w-80 md:h-80 lg:w-96 lg:h-96 object-contain rounded-lg shadow-2xl image-smooth"
                style={{
        ...
        <SmoothFadeIn delay={0.5}>
          ...
          >
            ...
            >
              <SmoothGradientText>Shailendra Mourya</SmoothGradientText>
            </motion.h1>
            ...
            >
              <SmoothMagneticElement strength={0.2}>
                <a href="#projects" className="btn-primary text-base sm:text-lg shadow-lg w-full sm:w-auto text-center hover-lift">View Projects</a>
              </SmoothMagneticElement>
              <SmoothMagneticElement strength={0.2}>
                <a href="/assets/Resume.pdf" className="btn-secondary text-base sm:text-lg shadow-lg w-full sm:w-auto text-center hover-lift" target="_blank" rel="noopener noreferrer">Download Resume</a>
              </SmoothMagneticElement>
            </motion.div>
          </motion.div>
        </SmoothFadeIn>
